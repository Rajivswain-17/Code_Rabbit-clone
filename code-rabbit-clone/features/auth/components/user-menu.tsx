...
import { SIGN_IN_PATH } from "../utilis";

import { RiArrowUpCircleFill, RiLogoutCircleLine } from "@remixicon/react";
      ...
      >
        ...
        {variant === "profile" ? (
          <>
            ...
            <RiArrowUpCircleFill className="size-4 text-muted-foreground" />
          </>
        ) : null}
      </DropdownMenuTrigger>
